...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>B.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),B.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>B.jsx("div",{className:"CommentList",children:e.map(t=>B.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{children:[" Posted by ",B.jsx(Pc,{user:e.user})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length===0?B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):B.jsx(Tc,{comments:e.comments})]}),Rc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Mc,{post:t},t.id))}),Dc=Cc.map(e=>({...e,user:zc.find(t=>t.id===e.userId),comments:Nc.filter(t=>t.postId===e.id)})),jc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Rc,{posts:Dc})]});em(document.getElementById("root")).render(B.jsx(jc,{}));
